                        ...
                        <div class="col-lg-4 widget-area sidebar-left">
                            <aside class="widget widget-nav-menu">
                                <ul>
                                    ...
                                    <li class="active"><a href="fabric-dyeing.html"> Fabric Dyeing </a></li>
                        ...
                        <div class="col-lg-8 content-area">
                            <div class="ttm-service-single-content-area">
                                <div class="ttm-featured-wrapper margin_bottom40">
                                    <img class="img-fluid" src="{{asset('/')}}frontend-asset/images/services/services-05-1200x800.jpg" alt="services-05">
                                </div>
                                <div class="ttm-service-description">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img class="img-fluid auto_size" width="494" height="560" src="{{asset('/')}}frontend-asset/images/single-img-13.jpg" alt="image"> 
                                        </div>
                                        <div class="col-md-8">
                                            <div class="res-767-margin_top30">
