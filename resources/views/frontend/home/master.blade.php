...
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/bootstrap.min.css" media="all"/>
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/animate.css" media="all"/>
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/font-awesome.css" media="all"/>
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/flaticon.css" media="all"/>
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/themify-icons.css" media="all"/>
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/slick.css" media="all"/>
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/prettyPhoto.css" media="all/">
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/shortcodes.css" media="all"/>
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/main.css" media="all"/>
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/megamenu.css" media="all"/>
<link rel="stylesheet" type="text/css" href="{{asset('/')}}frontend-asset/css/responsive.css" media="all"/>
...
<body>
    ...
    <div class="page">
        ...
        <!--header start-->
        @include('frontend.home.includes.home_header')
        <!--header end-->
        ...
        <!--footer start-->
        @include('frontend.home.includes.home_footer')
        <!--footer end-->
    ...
    <script src="{{asset('/')}}frontend-asset/js/jquery-migrate-3.3.2.min.js" defer></script>
    <script src="{{asset('/')}}frontend-asset/js/bootstrap.min.js" defer></script> 
    <script src="{{asset('/')}}frontend-asset/js/jquery.easing.js" defer></script> 
    <script src="{{asset('/')}}frontend-asset/js/jquery-waypoints.js" defer></script>    
    <script src="{{asset('/')}}frontend-asset/js/jquery-validate.js" defer></script> 
    <script src="{{asset('/')}}frontend-asset/js/jquery.prettyPhoto.js" defer></script>
    <script src="{{asset('/')}}frontend-asset/js/slick.min.js" defer></script>
    <script src="{{asset('/')}}frontend-asset/js/numinate.min.js" defer></script>
    <script src="{{asset('/')}}frontend-asset/js/imagesloaded.min.js" defer></script>
    <script src="{{asset('/')}}frontend-asset/js/jquery-isotope.js" defer></script>
    <script src="{{asset('/')}}frontend-asset/js/main.js" defer></script>
    <!-- Javascript end-->
