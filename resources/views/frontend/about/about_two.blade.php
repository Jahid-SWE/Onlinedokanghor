                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="ttm_single_image-wrapper text-left">
                                <img class="img-fluid" src="{{asset('/')}}frontend-asset/images/single-img-09.png" alt="single-09">
                            </div>
                        </div>
                                ...
                                <div class="ttm-highlight-quote margin_top35 clearfix">
                                    ...
                                    <div class="d-flex align-items-center">   
                                        <div class="d-inline-block">                                             
                                            <img class="img-fluid auto_size" width="90" height="89" src="{{asset('/')}}frontend-asset/images/author-quote.png" alt="author-quote">
                                        </div>
