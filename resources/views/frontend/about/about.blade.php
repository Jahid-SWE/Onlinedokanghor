                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-sm-8">
                        <div class="ttm_single_image-wrapper">
                            <img class="img-fluid auto_size" width="475" height="624" src="{{asset('/')}}frontend-asset/images/single-img-07.jpg" alt="single-07">
                        </div>
                    </div>
                        ...
                        <div class="padding_left30 padding_top20 res-991-padding_left0 res-991-padding_top40">
                            ...
                            <div class="d-sm-flex align-items-center">
                                <div class="ttm_single_image-wrapper text-left m-0">
                                    <img class="img-fluid auto_size" width="168" height="88" src="{{asset('/')}}frontend-asset/images/single-img-08.jpg" alt="single-08">
                                </div>
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="ttm-team-box-view-overlay">
                                ...
                                <div class="featured-thumbnail">
                                    <img class="img-fluid" src="{{asset('/')}}frontend-asset/images/team-member/team-img01.jpg" alt="image">
                                </div>
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="ttm-team-box-view-overlay">
                                ...
                                <div class="featured-thumbnail">
                                    <img class="img-fluid" src="{{asset('/')}}frontend-asset/images/team-member/team-img02.jpg" alt="image">
                                </div>
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="ttm-team-box-view-overlay">
                                ...
                                <div class="featured-thumbnail">
                                    <img class="img-fluid" src="{{asset('/')}}frontend-asset/images/team-member/team-img03.jpg" alt="image">
                                </div>
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="ttm-team-box-view-overlay">
                                ...
                                <div class="featured-thumbnail">
                                    <img class="img-fluid" src="{{asset('/')}}frontend-asset/images/team-member/team-img04.jpg" alt="image">
                                </div>
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="ttm-team-box-view-overlay">
                                ...
                                <div class="featured-thumbnail">
                                    <img class="img-fluid" src="{{asset('/')}}frontend-asset/images/team-member/team-img05.jpg" alt="image">
                                </div>
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
