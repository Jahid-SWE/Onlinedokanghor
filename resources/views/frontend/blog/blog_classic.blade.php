                ...
                <div class="row">
                    <div class="col-lg-8 content-area">
                        ...
                        <article class="post ttm-blog-classic clearfix">
                            ...
                            <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
                                <div class="ttm-post-featured">
                                    <img class="img-fluid" src="{{asset('/')}}frontend-asset/images/blog/blog-01-1200x800.jpg" alt="blog-img">
                        ...
                        <article class="post ttm-blog-classic clearfix">
                            ...
                            <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
                                <div class="ttm-post-featured">
                                    <img class="img-fluid" src="{{asset('/')}}frontend-asset/images/blog/blog-02-1200x800.jpg" alt="blog-img">
                                    <div class="ttm-box-post-date">
                                        <span class="ttm-entry-date">
                        ...
                        <article class="post ttm-blog-classic clearfix">
                            ...
                            <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
                                <div class="ttm-post-featured">
                                    <img class="img-fluid" src="{{asset('/')}}frontend-asset/images/blog/blog-03-1200x800.jpg" alt="blog-img">
                                    <div class="ttm-box-post-date">
                                        <span class="ttm-entry-date">
